...
{   
   ...
   @Test
   public void throwsNothing_2(){Circle c = new Circle(10);}
   ...
   public void throwsNegativeRadiusException(){Circle c = new Circle(-1);}

   @Test(expected = CircleException.class)
   public void throwsCircleException_1(){Circle c = new Circle(-3);}

   @Test(expected = CircleException.class)
   public void throwsCircleException_2(){Circle c = new Circle(0);}
}
