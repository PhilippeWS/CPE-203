...
final class WorldView
{
   ...
   {
      int newCol = this.viewport.clamp(this.viewport.getCol() + colDelta, 0,
              this.world.getNumCols() - this.viewport.getNumCols());
      int newRow = this.viewport.clamp(this.viewport.getRow() + rowDelta, 0,
              this.world.getNumRows() - this.viewport.getNumRows());

      this.viewport.shift(newCol, newRow);
      this.viewport.incrementDeltas(colDelta, rowDelta);
   }
